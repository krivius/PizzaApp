...
@section('content')
        ...
        <div id="featured-content">
            <div id="column1">
                ...
                <p><img src="images/pizza/1.png" width="300" height="150" alt="" /></p>
                <p>Etiam non felis. Donec ut ante. In id eros. Suspendisse lacus turpis, cursus egestas at sem. Mauris quam enim, molestie.</p>
                <p class="button"><a href="#">Add to cart</a></p>
            </div>
            <div id="column2">
                <h2>Fusce fringilla</h2>
                <p><img src="images/pizza/2.png" width="300" height="150" alt="" /></p>
                <p>Etiam non felis. Donec ut ante. In id eros. Suspendisse lacus turpis, cursus egestas at sem. Mauris quam enim, molestie.</p>
                <p class="button"><a href="#">Add to cart</a></p>
            </div>
            <div id="column3">
            ...
            <div id="content">
                <div class="post">
                    ...
                    <div class="entry">
                        ...
                        <p class="links"><a href="#" class="more">Add to cart</a><a href="#" title="b0x" class="comments">Comments</a></p>
                    </div>
                </div>
            </div>
            <!-- end #content -->
